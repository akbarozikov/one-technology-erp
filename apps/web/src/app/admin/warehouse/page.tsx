...
export default function WarehouseLandingPage() {
  ...
  return (
    <DomainLandingLive
      title="Warehouse"
      summary="Manage reservations, stock movement history, and warehouse paperwork."
      description="Use this area to understand what stock is reserved, what has moved, and which warehouse documents still matter. Start with reservations and stock movements, then open receipts, transfers, counts, adjustments, or writeoffs as needed."
      links={[
        {
          href: "/admin/stock-reservations",
          label: "Stock Reservations",
          description: "Review reservations tied to quotes, orders, and configurations.",
        },
        {
          href: "/admin/stock-movements",
          label: "Stock Movements",
          description: "Inspect movement history and operational issue records.",
        },
        {
          href: "/admin/stock-balances",
          label: "Stock Balances",
          description: "Check current on-hand, reserved, and available quantities.",
        },
        {
          href: "/admin/stock-transfer-documents",
          label: "Transfer Documents",
          description: "Open inter-warehouse transfer paperwork and its related lines.",
        },
      ]}
      loadData={loadData}
    />
