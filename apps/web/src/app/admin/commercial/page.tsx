...
export default function CommercialLandingPage() {
  ...
  return (
    <DomainLandingLive
      title="Commercial"
      summary="Work with quotes, orders, payments, and the commercial records that move deals toward completion."
      description="Use this area for proposal work, confirmed orders, payment follow-through, and the supporting records around them. Start with quotes and orders, then move into payments or line-level detail when needed."
      links={[
        {
          href: "/admin/quotes",
          label: "Quotes",
          description: "Create and review quotes for active opportunities.",
        },
        {
          href: "/admin/quote-versions",
          label: "Quote Versions",
          description: "Track revisions and generate proposal documents.",
        },
        {
          href: "/admin/orders",
          label: "Orders",
          description: "Manage confirmed customer commitments and downstream fulfillment context.",
        },
        {
          href: "/admin/payments",
          label: "Payments",
          description: "Record incoming payments and review payment progress by order.",
        },
      ]}
      loadData={loadData}
    />
