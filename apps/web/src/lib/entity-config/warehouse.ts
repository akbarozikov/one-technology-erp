...
export const warehouseConfigs = {
  ...
  stock_reservations: {
    ...
    fields: [
      ...
      { key: "position_id", label: "Position ID", kind: "number", required: true, section: "item" },
      { key: "reserved_qty", label: "Reserved qty", kind: "number", required: true, step: "any", min: 0.000001, section: "item" },
      { key: "quote_line_id", label: "Quote line ID", kind: "number", section: "context" },
      { key: "order_line_id", label: "Order line ID", kind: "number", section: "context" },
